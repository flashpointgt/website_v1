...
add_image_size( 'team-thumbs', 165, 140, true );
...
function theme_js(){
  ...
  wp_register_script('noisy', get_template_directory_uri().'/library/js/jquery.noisy.min.js');
  ...
  wp_enqueue_script('noisy', array('jQuery'), '1.1', true);
